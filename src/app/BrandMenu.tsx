 ...
 * a dark chip, and on hover the menu expands UPWARD to reveal the other surfaces. Mafinest, tight
 * tracking, the green/steel chip palette from the Figma blocking (node 35:3).
 */
